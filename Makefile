...
INSTALLER_VERSION=1.4.4.1
INSTALLER_PACKAGE=zmpkg-installer-$(INSTALLER_VERSION)
INSTALLER_DIR=dist/$(INSTALLER_PACKAGE)
ZMPKG_HELIX_REF=refs/tags/zcs-zmpkg-1.2.18
ZMPKG_IRONMAIDEN_REF=refs/tags/zcs-zmpkg-1.3.1.8
ZMPKG_JUDASPRIEST_REF=refs/tags/zcs-zmpkg-1.4.1.2
